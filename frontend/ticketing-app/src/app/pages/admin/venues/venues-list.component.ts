  ...
  template: `
    <div class="p-8 pb-16 space-y-8">
        ...
        <div *ngIf="!loading" class="overflow-x-auto">
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-slate-800/50 divide-y divide-slate-700/50">
              <tr *ngFor="let venue of filteredVenues" class="hover:bg-slate-700/50 transition-colors">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <span [class]="getStatusClass(venue.isActive)"
          ...
          <div *ngIf="filteredVenues.length === 0 && !loading" class="text-center py-12">
            ...
            <p class="text-slate-300 mb-4">
              {{ searchTerm || cityFilter || statusFilter ? 'No se encontraron venues con los filtros aplicados.' : 'Comienza creando tu primer venue.' }}
            </p>
            <button *ngIf="!searchTerm && !cityFilter && !statusFilter"
      ...
      <div *ngIf="showModal"
           ...
           (click)="closeModal()">
        <div class="relative top-10 mx-auto p-5 border w-full max-w-md shadow-lg rounded-md bg-slate-800 border-slate-700"
          ...
          <div class="mt-3">
            ...
            <form (ngSubmit)="saveVenue()" class="space-y-4">
              ...
              <div>
                ...
                <input [(ngModel)]="venueForm.address"
                       name="address"
                       type="text"
                       required
              ...
              <div>
                ...
                <input [(ngModel)]="venueForm.capacity"
                       name="capacity"
                       type="number"
                       required
                       min="1"
              ...
              <div>
                <label class="flex items-center">
                  <input [(ngModel)]="venueForm.isActive"
                         name="isActive"
                         type="checkbox"
...
export class VenuesListComponent implements OnInit {
  ...
  filterVenues() {
    this.filteredVenues = this.venues.filter(venue => {
      ...
      const matchesStatus = !this.statusFilter ||
        venue.isActive.toString() === this.statusFilter;
  ...
  saveVenue() {
    ...
    if (this.isEditing && this.venueForm.id) {
      const venueUpdateData = {
        ...
        slug: (this.venueForm.name || '').toLowerCase()
          .replace(/[^a-z0-9\s-]/g, '')
          .replace(/\s+/g, '-')
          .replace(/-+/g, '-')
          .replace(/^-+|-+$/g, '')
  ...
  deleteVenue(venue: Venue) {
    if (confirm(`¿Estás seguro de que quieres eliminar el venue "${venue.name}"? Esta acción no se puede deshacer.`)) {
