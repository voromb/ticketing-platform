...
exports.MessagingUsersController = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
class MessagingUsersController {
    // GET /api/messaging-users/admins - Lista simplificada de admins para mensajería
    async getAdminsForMessaging(request, reply) {
        try {
    ...
    async getCompanyAdminsForMessaging(request, reply) {
        try {
    ...
    async getAllAdminsForMessaging(request, reply) {
        try {
...
exports.MessagingUsersController = MessagingUsersController;
